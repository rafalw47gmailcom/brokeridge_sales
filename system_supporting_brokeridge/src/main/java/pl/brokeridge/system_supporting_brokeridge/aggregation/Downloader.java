...
public class Downloader {
    ...
    public Downloader(String url) throws IOException {
        ...
        this.donwloadedTours = getDownloadedTours(url);
        System.out.println(donwloadedTours);
    }

    private static List<Tour> getDownloadedTours(String url) throws IOException {
